...
<div class="appointments form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('user_id',['label' => 'Patient','options' => $users]);
            echo $this->Form->control('title',['label' => 'Appointment Title']);
            echo $this->Form->control('app_time', ['label'=>'Appointment Time','empty' => true]);
            echo $this->Form->control('app_status',['label' => 'Appointment Status','options' =>['pending'=>'pending','confirm'=>'confirm','reject'=>'reject']]);
        ?>
    </fieldset>
